...
export const HistorySidebar: React.FC<HistorySidebarProps> = ({ history, onSelect, onClear, isOpen, setIsOpen }) => {
  ...
  return (
    <>
      <div
        className={cn(
          'workspace-history-sidebar-backdrop fixed inset-0 z-40 bg-slate-950/70 backdrop-blur-sm transition-opacity duration-200 lg:hidden',
      ...
      <aside
        className={cn(
          'workspace-history-sidebar fixed left-0 top-0 z-50 flex h-full w-[18rem] max-w-[85vw] flex-col overflow-hidden border-r border-white/8 bg-[rgba(10,13,20,0.98)] shadow-2xl shadow-black/40 transition-transform duration-300 ease-out lg:hidden',
